...
Source: ftp://prdownloads.sourceforge.net/rexxtrans/RexxTrans-1.5.tar.gz
...
/usr/lib/librexxtrans.so.1.5
/usr/bin/rexxtrans-config

%post
cd /usr/lib
ln -sf ./librexxtrans.so.1.5 ./librexxtrans.so.1
ln -sf ./librexxtrans.so.1.5 ./librexxtrans.so
ldconfig /usr/lib
