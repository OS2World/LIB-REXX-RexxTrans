...
Source: ftp://ftp.lightlink.com/pub/hessling/RexxTrans/RexxTrans-1.2.tar.gz
%description
...
/usr/lib/librexxtrans.so.1.2

%post
cd /usr/lib
ln -sf ./librexxtrans.so.1.2 ./librexxtrans.so.1
ln -sf ./librexxtrans.so.1.2 ./librexxtrans.so
ldconfig /usr/lib
